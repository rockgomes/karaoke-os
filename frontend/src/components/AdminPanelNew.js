...
const AdminPanelNew = ({ selectedLibrary, onLibrarySelect }) => {
  ...
  const fetchSongs = async () => {
    ...
    try {
      const response = await axios.get(`/api/libraries/${selectedLibrary.id}/songs`);
  ...
  const handleAddSong = async (e) => {
    ...
    try {
      ...
      setFormData({ title: '', artist: '', genre: '', duration: '', year: '', album: '' });
      onAddClose();
  ...
  const handleDeleteSong = async (songId) => {
    try {
      await axios.delete(`/api/libraries/${selectedLibrary.id}/songs/${songId}`);
  ...
  return (
    <div className="admin-panel-new">
      ...
      <div className="admin-panel-new__header">
        <div className="admin-panel-new__header-left">
          ...
          <p className="admin-panel-new__subtitle">
            Manage your music database. Enable AI to auto-tag genres and duration.
          </p>
        </div>
      ...
      <div className="admin-panel-new__ai-banner">
        ...
        <Button size="sm" variant="light">Learn More</Button>
      </div>
        ...
        <ModalContent>
          <form onSubmit={handleAddSong}>
            ...
            <ModalFooter>
              ...
              <Button color="primary" type="submit">Add Song</Button>
            </ModalFooter>
          </form>
        </ModalContent>
      </Modal>
      ...
      <Modal isOpen={isEditOpen} onClose={onEditClose} size="2xl">
        <ModalContent>
          <form onSubmit={handleEditSong}>
            ...
            <ModalFooter>
              <Button variant="flat" onPress={onEditClose}>Cancel</Button>
